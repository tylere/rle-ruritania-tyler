...
- Access to the GCP project (e.g., `rle-ruritania-tyler`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-tyler" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-tyler.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-tyler --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-tyler.iam.gserviceaccount.com" \
  --project="rle-ruritania-tyler" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-tyler.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-tyler.
