...
- Access to the GCP project (e.g., `rle-ruritania-tyler176`)
...
gcloud iam workload-identity-pools create "github-pool" \
  --project="rle-ruritania-tyler176" \
  --location="global" \
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-tyler176" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-tyler176.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-tyler176 --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-tyler176.iam.gserviceaccount.com" \
  --project="rle-ruritania-tyler176" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-tyler176.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-tyler176.
